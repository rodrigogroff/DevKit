...
{
    public class TipoCoberturaDependenteComboController : ApiControllerBase
    {
        public IHttpActionResult Get()
        {
            ...
            var ret = new TipoCoberturaDependente().ComboFilters(db, parameters);
        ...
        public IHttpActionResult Get(long id)
        {
          //  if (RestoreCache(CacheTags.EstadoCombo, id) is BaseComboResponse obj)
            ...
            var mdl = (from e in db.TipoCoberturaDependente
                       where e.id == id
