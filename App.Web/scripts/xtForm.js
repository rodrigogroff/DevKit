...
*/
  function DefaultErrorMessages() {
      this.minlength = 'Precisa ter pelo menos {{minlength}} caracteres';
      this.maxlength = 'Não pode ter mais que {{maxlength}} caracteres';
      this.required = 'Este campo é obrigatório';
      this.number = 'Deve ser um número';
      this.min = 'Deve ser no mínimo {{min}}';
      this.max = 'Deve ser no máximo {{max}}';
      this.email = 'E-mail inválido';
      this.pattern = 'Valor inválido';
  }
