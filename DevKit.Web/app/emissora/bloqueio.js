...
angular.module('app.controllers').controller('EmissoraBloqueioController',
    ...
    function CheckPermissions() {
        Api.Permission.get({ id: $scope.permID }, function (data) {
            ...
            if (!$scope.permModel.edicao) {
                toastr.error('Acesso negado para bloqueio de cartão!', 'Permissão');
                $state.go('home');
            }
        },
            function (response) { });
