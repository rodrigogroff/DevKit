...
namespace DataModel
{
	...
	public class EnumAuditAction
	{
        ...
        public EnumAuditAction()
		{
            ...
            lst.Add(new AuditAction() { id = PersonCreate, stName = "Pessoa \\ Criação de cadastro" });
            lst.Add(new AuditAction() { id = PersonUpdate, stName = "Pessoa \\ Atualização de cadastro" });
            lst.Add(new AuditAction() { id = PersonAddPhone, stName = "Pessoa \\ Novo telefone" });
            lst.Add(new AuditAction() { id = PersonEditPhone, stName = "Pessoa \\ Editar telefone" });
            lst.Add(new AuditAction() { id = PersonRemovePhone, stName = "Pessoa \\ Remover telefone" });
            lst.Add(new AuditAction() { id = PersonAddEmail, stName = "Pessoa \\ Novo email" });
            lst.Add(new AuditAction() { id = PersonEditEmail, stName = "Pessoa \\ Editar email" });
            lst.Add(new AuditAction() { id = PersonRemoveEmail, stName = "Pessoa \\ Remover email" });
