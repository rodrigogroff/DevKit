...
angular.module('app.controllers').controller('EmissoraDespesaController',
        ...
        function ($scope, $rootScope, $state, $stateParams, Api ) {
            ...
            function init() {
                if (id > 0) {
                    $scope.loading = true;
                    $scope.id = id;
                    Api.EmissoraDespesa.get({ id: id }, function (data) {
            ...
            $scope.save = function () {
                ...
                {
                    if (id > 0) {
                        Api.EmissoraDespesa.update({ id: id }, $scope.viewModel, function (data) {
                        ...
                        Api.EmissoraDespesa.add($scope.viewModel, function (data) {
                            toastr.success('Despesa salva!', 'Sucesso');
